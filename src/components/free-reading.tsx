...
// WA_LINK is no longer hardcoded — routing is configured in siteContent.json
// const was: 'https://wa.me/85256151619'
...
export default function FreeReading({ variant = 'section' }: FreeReadingProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Use the router module via the /api/redirect endpoint
    const params = new URLSearchParams({
      from: 'free-reading',
      campaign: 'free-reading',
      name: name.trim(),
      question: question.trim() || 'General guidance',
    });

    // Open the redirect URL — server handles routing + message templating
