...
const service = services.find((s: any) => s.slug === 'fengshui-consultation');

export default function FengShuiConsultPage() {
    ...
    <div className="section">
      <div className="container max-w-3xl">
        <nav className="text-sm text-gray-500 mb-8">
          <Link href="/" className="hover:text-accent">Home</Link> / <Link href="/feng-shui" className="hover:text-accent">Feng Shui</Link> / <span className="text-ink">{service.title}</span>
        </nav>
