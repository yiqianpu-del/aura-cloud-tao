...
export default async function QiMenDeckPage() {
  const products = await getProducts() || [];
  const product = products.find((p: any) => p.slug === 'qi-men-deck');
      ...
      <div className="container max-w-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            ...
            <a href={`/api/redirect?from=shop-qi-men-deck&campaign=cta`} className="btn btn-gold">Inquire on WhatsApp</a>
          </div>
        </div>
