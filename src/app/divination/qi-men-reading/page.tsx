...
const service = services.find((s: any) => s.slug === 'qi-men-reading');

export default function QiMenReadingPage() {
    ...
    <div className="section">
      <div className="container max-w-3xl">
        <nav className="text-sm text-gray-500 mb-8">
          <Link href="/" className="hover:text-accent">Home</Link> / <Link href="/divination" className="hover:text-accent">Divination</Link> / <span className="text-ink">{service.title}</span>
        </nav>
