  ...
  return (
    <div className="section">
      <div className="container">
        ...
        <h1 className="text-3xl md:text-5xl font-bold mb-4">Spiritual Shop</h1>
        <p className="text-xl text-gray-600 max-w-3xl mb-2">Hand-crafted Taoist spiritual products for your practice and daily life</p>
        <p className="text-sm text-gray-500 italic mb-12">Each item consecrated with intention — shop via WhatsApp</p>
        ...
        <div className="text-center mt-12"><a href="https://wa.me/85256151619?text=I'd%20like%20to%20browse%20your%20shop" target="_blank" className="btn btn-primary btn-lg">Inquire on WhatsApp</a></div>
      </div>
    </div>
  );
}
